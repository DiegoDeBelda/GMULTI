package com.example.mati.contentprovider2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnConsultar.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                String uri = "com.example.mati.contentprovider.ContentProvider";
        ...
        btnLlamadas.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Cursor cur = cr.query(llamadasUri, proyeccion, null, null, null);      //Orden de los resultados
