...
public class Final extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dibujarfigura);
    ...
    public static class FiguraVisualizacion extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if(figura.equals("Circulo")){
                ...
                textv6.setText(String.valueOf(DrawShapes3.circulo.area()));
            ...
            if(figura.equals("Cuadrado")) {
                ...
                textv2.setVisibility(TextView.INVISIBLE);
                textv5.setText("Area es: ");
                textv6.setText(String.valueOf(DrawShapes3.cuadrado.area()));
            ...
            if(figura.equals("Rectangulo")){
                ...
                textv5.setText("Area es: ");
                textv6.setText(String.valueOf(DrawShapes3.rectangulo.area()));
